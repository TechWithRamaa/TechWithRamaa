...
Jupyter Notebooks, Pandas, NumPy, HazelCast/Coherence, **Amazon DynamoDB, NoSQL, Cassandra, Vector Databases**, **Transfer Learning**, Key-Value Data Store, **In-Memory Processing Grid**, Performance Monitoring & Tuning, Memory Turning, Lean Systems, Extendable Systems, **Advanced Data Structures**,   
**Low Level System Design**, **High Level System Design**, Socket Programming, Low latency & High thoughput systems
